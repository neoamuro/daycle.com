...
import com.daycle.daycleapp.custom.swipelistview.util.AbsListViewWrapper;
...
import com.daycle.daycleapp.custom.swipelistview.util.ListViewWrapperSetter;
...
public abstract class BaseAdapterDecorator extends BaseAdapter implements SectionIndexer, Swappable, Insertable, ListViewWrapperSetter {
    ...
    public void notifyDataSetChanged() {
        if (!(mDecoratedBaseAdapter instanceof com.daycle.daycleapp.custom.swipelistview.ArrayAdapter<?>)) {
            // fix #35 dirty trick !
    ...
    public void notifyDataSetChanged(final boolean force) {
        if (force || !(mDecoratedBaseAdapter instanceof com.daycle.daycleapp.custom.swipelistview.ArrayAdapter<?>)) {
            // leads to an infinite loop when trying because ArrayAdapter triggers notifyDataSetChanged itself
            // TODO: investigate
            mDecoratedBaseAdapter.notifyDataSetChanged();
        }
