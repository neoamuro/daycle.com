...
/**
 * An interface which provides a callback that is called when an item has moved using the {@link com.daycle.daycleapp.custom.swipelistview.itemmanipulation.dragdrop.rewrite.DynamicListView}.
 */
