...
public class TimedUndoAdapter extends SimpleSwipeUndoAdapter {
     ...
     */
    public <V extends BaseAdapter & com.daycle.daycleapp.custom.swipelistview.itemmanipulation.swipedismiss.undo.UndoAdapter> TimedUndoAdapter(@NonNull final V undoAdapter, @NonNull final Context context, @NonNull final OnDismissCallback
            dismissCallback) {
    ...
    public void onDismiss(@NonNull final ViewGroup listView, @NonNull final int[] reverseSortedPositions, boolean flingToRight) {
        super.onDismiss(listView, reverseSortedPositions, flingToRight);
