...
package com.daycle.daycleapp.custom.swipelistview.itemmanipulation.animateaddition;
...
public class AnimateAdditionAdapter<T> extends BaseAdapterDecorator {
    ...
    @NonNull
    private final com.daycle.daycleapp.custom.swipelistview.itemmanipulation.animateaddition.InsertQueue<T> mInsertQueue;
    ...
    public AnimateAdditionAdapter(@NonNull final BaseAdapter baseAdapter) {
        ...
        mInsertQueue = new com.daycle.daycleapp.custom.swipelistview.itemmanipulation.animateaddition.InsertQueue<>(mInsertable);
    }
