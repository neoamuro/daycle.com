...
public class SwipeDismissAdapter extends BaseAdapterDecorator {
    ...
    @NonNull
    private final com.daycle.daycleapp.custom.swipelistview.itemmanipulation.swipedismiss.OnDismissCallback mOnDismissCallback;
     ...
     * @param onDismissCallback the {@link com.daycle.daycleapp.custom.swipelistview.itemmanipulation.swipedismiss.OnDismissCallback} to be notified of dismissed items.
     */
    public SwipeDismissAdapter(@NonNull final BaseAdapter baseAdapter, @NonNull final com.daycle.daycleapp.custom.swipelistview.itemmanipulation.swipedismiss.OnDismissCallback onDismissCallback) {
        super(baseAdapter);
