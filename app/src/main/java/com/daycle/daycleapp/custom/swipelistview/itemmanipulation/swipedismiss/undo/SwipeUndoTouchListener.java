...
public class SwipeUndoTouchListener extends SwipeDismissTouchListener {
     ...
     */
    @NonNull
    private final com.daycle.daycleapp.custom.swipelistview.itemmanipulation.swipedismiss.undo.UndoCallback mCallback;
    ...
    /**
     * If necessary, notifies the {@link com.daycle.daycleapp.custom.swipelistview.itemmanipulation.swipedismiss.undo.UndoCallback} to remove dismissed object from the adapter,
    ...
    protected void finalizeDismiss() {
        if (getActiveDismissCount() == 0 && getActiveSwipeCount() == 0) {
            ...
            Collection<Integer> newUndoPositions = com.daycle.daycleapp.custom.swipelistview.itemmanipulation.swipedismiss.undo.Util.processDeletions(mUndoPositions, mDismissedPositions);
