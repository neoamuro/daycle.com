...
import com.daycle.daycleapp.custom.swipelistview.itemmanipulation.TouchEventHandler;
import com.daycle.daycleapp.custom.swipelistview.util.Swappable;
...
public class DragAndDropHandler implements TouchEventHandler {
     ...
     */
    @Nullable
    private com.daycle.daycleapp.custom.swipelistview.itemmanipulation.dragdrop.HoverDrawable mHoverDrawable;
    ...
    /**
     * The {@link com.daycle.daycleapp.custom.swipelistview.itemmanipulation.dragdrop.DraggableManager} responsible for deciding if an item can be dragged.
     */
    @NonNull
    private com.daycle.daycleapp.custom.swipelistview.itemmanipulation.dragdrop.DraggableManager mDraggableManager;
...
//            View view = (View)mMobileView.findViewById(R.id.itemContent);
//            view.setBackgroundColor(ContextCompat.getColor(mMobileView.getContext(), R.color.colorAccent));

            mHoverDrawable = new com.daycle.daycleapp.custom.swipelistview.itemmanipulation.dragdrop.HoverDrawable(mMobileView, mLastMotionEventY);
            mMobileView.setVisibility(View.INVISIBLE);
        }
    }

    /**
     * Sets the {@link com.daycle.daycleapp.custom.swipelistview.itemmanipulation.dragdrop.DraggableManager} to be used for determining whether an item should be dragged when the user issues a down {@code MotionEvent}.
     */
    public void setDraggableManager(@NonNull final com.daycle.daycleapp.custom.swipelistview.itemmanipulation.dragdrop.DraggableManager draggableManager) {
     ...
     * <p/>
     * Finds the position and {@code View} of the touch point and, if allowed by the {@link com.daycle.daycleapp.custom.swipelistview.itemmanipulation.dragdrop.DraggableManager},
    ...
    /**
     * By default, nothing is draggable. User should set a {@link com.daycle.daycleapp.custom.swipelistview.itemmanipulation.dragdrop.DraggableManager} manually,
     * or use {@link #startDragging(int)} if they want to start a drag (for example using a long click listener).
     */
    private static class DefaultDraggableManager implements com.daycle.daycleapp.custom.swipelistview.itemmanipulation.dragdrop.DraggableManager {
    ...
    private class SettleHoverDrawableAnimatorListener extends AnimatorListenerAdapter implements ValueAnimator.AnimatorUpdateListener {
        ...
        @NonNull
        private final com.daycle.daycleapp.custom.swipelistview.itemmanipulation.dragdrop.HoverDrawable mAnimatingHoverDrawable;

        @NonNull
        private final View mAnimatingMobileView;

        private SettleHoverDrawableAnimatorListener(@NonNull final com.daycle.daycleapp.custom.swipelistview.itemmanipulation.dragdrop.HoverDrawable animatingHoverDrawable, @NonNull final View animatingMobileView) {
